...
app.listen(PORT, () => {
  ...
  console.log('');
  console.log(`🔄  Sistema de Retorno: /api/atestados/:id/retornar`);
  console.log(`📊  Estatísticas Atestados: /api/atestados/estatisticas`);
  console.log(`👥  Funcionários Afastados: /api/funcionarios/afastados`);
